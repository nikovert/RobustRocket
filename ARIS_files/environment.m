%% Environment  Class
% Most variables about the atmosphere are stored in the class and are
% usually used by the simulater only (not the controller)
...
classdef environment<handle
   ...
   methods
       function obj = environment(val1, val2, val3,val4)
          if nargin > 0
